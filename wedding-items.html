...
<div class="page-banner">
  <span class="eyebrow">Wedding Items</span>
  <h1>Vivah ki parampara, poori taiyari ke saath</h1>
  <p>Har samuday ki apni riti — hum har ek ke liye authentic saman rakhte hain.</p>
</div>

<section class="block">
  <div class="region-tabs">
    <span class="region-tab active">Sabhi</span>
    <span class="region-tab">Bengali</span>
    <span class="region-tab">Bihari</span>
    <span class="region-tab">Marwadi</span>
  </div>
  <div class="prod-grid">
    <div class="prod-card">
    ...
    <div class="prod-card">
      ...
      <button class="quick-add" onclick="quickAdd('mandap-flowers')" aria-label="Add to cart">+</button>
    </div>
  </div>
</section>
...
<section class="block">
  <div class="wa-feature">
    ...
    <div class="wa-mock">
      <div class="wa-bubble">Bengali wedding hai, February mein — kya kya chahiye hoga poora set?</div>
      <div class="wa-bubble me">Topor-Mukut, Gachkouto, Kalash aur mandap flowers ka poora package bhej raha hoon, ₹4200 total 🙏</div>
    </div>
  </div>
</section>
