...
<title>Contact — ShubhSamagri</title>
...
<div class="page-banner">
  ...
  <h1>Hume message karein</h1>
  <p>Order, sawaal, ya booking — kisi bhi cheez ke liye humse judein. Hum 24x7 WhatsApp par available hain.</p>
</div>
  ...
  <div class="contact-wrap">
    <div class="contact-form">
      <form onsubmit="return false;">
        ...
        <label>Message</label>
        <textarea rows="5" placeholder="Apni samagri list ya sawaal likhein..."></textarea>
        <button type="submit" class="btn-primary" style="border:none;cursor:pointer;">Message bhejein</button>
      </form>
    </div>
    <div class="contact-info">
      <div class="info-item">
        <svg viewBox="0 0 24 24" fill="none" stroke="#8B1E3F" stroke-width="2"><path d="M12 2a10 10 0 0 0-8.6 15L2 22l5.2-1.4A10 10 0 1 0 12 2z"/></svg>
        <div><h4>WhatsApp</h4><p>+91 00000 00000 — 24x7 order aur booking ke liye</p></div>
      </div>
      <div class="info-item">
        <svg viewBox="0 0 24 24" fill="none" stroke="#8B1E3F" stroke-width="2"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M3 7l9 6 9-6"/></svg>
        <div><h4>Email</h4><p>hello@shubhsamagri.com</p></div>
      </div>
      <div class="info-item">
        <svg viewBox="0 0 24 24" fill="none" stroke="#8B1E3F" stroke-width="2"><path d="M12 21s-7-6-7-12a7 7 0 0 1 14 0c0 6-7 12-7 12z"/><circle cx="12" cy="9" r="2.5"/></svg>
        <div><h4>Location</h4><p>Local delivery + services aapke shehar mein, shipping poore Bharat mein</p></div>
      </div>
      <div class="info-item">
        <svg viewBox="0 0 24 24" fill="none" stroke="#8B1E3F" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/></svg>
        <div><h4>Support Hours</h4><p>24x7 WhatsApp support, phone support 8 AM – 9 PM</p></div>
      </div>
    </div>
  </div>
</section>
