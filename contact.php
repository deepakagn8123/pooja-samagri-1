...
<div class="page-banner">
    ...
    <p>
        Order, sawaal, ya booking — kisi bhi cheez ke liye humse judein.
        Hum 24x7 WhatsApp par available hain.
    </p>
    ...
    <div class="contact-wrap">
        ...
        <div class="contact-form">
            ...
            <form onsubmit="return false;">
                ...
                <textarea
                    rows="5"
                    placeholder="Apni samagri list ya sawaal likhein..."
                ></textarea>
        ...
        <div class="contact-info">
            ...
            <div class="info-item">
                ...
                <div>
                    ...
                    <p>
                        Local delivery + services aapke shehar mein,
